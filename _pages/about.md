...
<body>
        ...
        <div class="font-control-panel">
            ...
            <div class="control-group">
                <div class="control-item">
                    <label for="authors-size">作者大小:</label>
                    <input type="range" id="authors-size" min="10" max="18" value="14" step="0.5">
                    <span class="font-size-display" id="authors-display">14px</span>
                </div>
                <div class="control-item">
                    <label for="title-size">标题大小:</label>
                    <input type="range" id="title-size" min="12" max="20" value="16" step="0.5">
                    <span class="font-size-display" id="title-display">16px</span>
                </div>
                <div class="control-item">
                    <label for="journal-size">期刊大小:</label>
                    <input type="range" id="journal-size" min="10" max="18" value="14" step="0.5">
                    <span class="font-size-display" id="journal-display">14px</span>
                </div>
                <div class="control-item">
                    <label for="details-size">详情大小:</label>
                    <input type="range" id="details-size" min="10" max="16" value="13" step="0.5">
                    <span class="font-size-display" id="details-display">13px</span>
                </div>
            </div>
            <button class="reset-button" id="reset-fonts">重置字体大小</button>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // 获取所有控制元素
            const authorsSize = document.getElementById('authors-size');
            const titleSize = document.getElementById('title-size');
            const journalSize = document.getElementById('journal-size');
            const detailsSize = document.getElementById('details-size');
            const resetButton = document.getElementById('reset-fonts');
            ...
            // 初始化显示值
            authorsDisplay.textContent = authorsSize.value + 'px';
            titleDisplay.textContent = titleSize.value + 'px';
            journalDisplay.textContent = journalSize.value + 'px';
            detailsDisplay.textContent = detailsSize.value + 'px';
            
            // 作者字体大小控制
            authorsSize.addEventListener('input', function() {
                const size = this.value + 'px';
                authorsDisplay.textContent = size;
            ...
            titleSize.addEventListener('input', function() {
                const size = this.value + 'px';
                titleDisplay.textContent = size;
                document.querySelectorAll('.paper-title').forEach(el => {
                    el.style.fontSize = size;
                });
            });
            
            // 期刊字体大小控制
            journalSize.addEventListener('input', function() {
                const size = this.value + 'px';
                journalDisplay.textContent = size;
                document.querySelectorAll('.journal-name').forEach(el => {
                    el.style.fontSize = size;
                });
            });
            
            // 详情字体大小控制
            detailsSize.addEventListener('input', function() {
                const size = this.value + 'px';
                detailsDisplay.textContent = size;
                document.querySelectorAll('.publication-details, .conference-info').forEach(el => {
                    el.style.fontSize = size;
                });
            });
            ...
            resetButton.addEventListener('click', function() {
                // 重置滑块值
                authorsSize.value = 14;
                titleSize.value = 16;
                journalSize.value = 14;
                detailsSize.value = 13;
                
                // 更新显示
                authorsDisplay.textContent = '14px';
                titleDisplay.textContent = '16px';
                journalDisplay.textContent = '14px';
                detailsDisplay.textContent = '13px';
