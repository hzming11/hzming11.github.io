...
* Artifical intelligence: deep reinforcement learning (DRL), evolutionary computation (multi and many objectives evolutionary optimization)
* network communications: reconfigurable intelligent surface (RIS), edge computing, edge caching
